...
class DealixKnowledge:
    ...
    PRICING = {
        "starter": {
            "name_ar": "المبتدئ",
            "price": 299,
            "features_ar": ["٣ مستخدمين", "٥٠٠ عميل", "واتساب أساسي", "تقارير أساسية", "قالب صناعة واحد"],
        ...
        "professional": {
            ...
            "features_ar": [
                ...
                "تسلسلات تلقائية", "عروض أسعار CPQ", "واتساب ذكي",
                "إيميل brain", "تقارير متقدمة + تنبؤات",
            ],
        ...
        "business": {
            ...
            "price": 1999,
            "features_ar": [
                "٢٥ مستخدم", "صفقات استراتيجية (١٥ نوع)", "Company Twin",
                "مفاوض AI بالعربي", "غرف صفقات", "LinkedIn brain",
                "Social media brain", "PDPL كامل", "API access",
            ],
            "best_for_ar": "الشركات النامية الباحثة عن شراكات",
        },
        "enterprise": {
            "name_ar": "المؤسسي",
            "price": 4999,
            "features_ar": [
                "مستخدمين لا محدود", "Strategic Growth OS كامل",
                "رصد استحواذات", "محاكي نمو استراتيجي", "ROI engine",
                "٧ أدمغة AI لكل قناة", "مدير حساب مخصص",
                "SLA 99.9%", "تدريب فريق", "White-label reporting",
            ],
            "best_for_ar": "الشركات الكبيرة والمجموعات",
        },
    }
