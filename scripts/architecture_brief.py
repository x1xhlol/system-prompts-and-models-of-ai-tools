...
CONSTITUTION_PATHS = [
    ...
    "docs/GTM_W1_PIPELINE_OUTREACH_EXECUTION_AR.md",
    "docs/GTM_W2_DEMO_PROPOSAL_ENGINE_AR.md",
    "docs/GTM_W3_FIRST_PAID_CLOSE_AR.md",
    "docs/GTM_W4_PILOT_EVIDENCE_LOOP_AR.md",
    "docs/GTM_GOVERNANCE_KPI_RHYTHM_AR.md",
