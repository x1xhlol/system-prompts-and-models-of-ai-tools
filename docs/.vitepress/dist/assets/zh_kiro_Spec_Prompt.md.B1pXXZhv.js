import{_ as n,c as a,o as p,ae as l}from"./chunks/framework.CBTkueSR.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/kiro/Spec_Prompt.md","filePath":"zh/kiro/Spec_Prompt.md","lastUpdated":1760450691000}'),e={name:"zh/kiro/Spec_Prompt.md"};function i(c,s,t,o,r,u){return p(),a("div",null,[...s[0]||(s[0]=[l(`<h2 id="spec-prompt-txt" tabindex="-1">Spec_Prompt.txt <a class="header-anchor" href="#spec-prompt-txt" aria-label="Permalink to &quot;Spec_Prompt.txt&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 系统提示</span></span>
