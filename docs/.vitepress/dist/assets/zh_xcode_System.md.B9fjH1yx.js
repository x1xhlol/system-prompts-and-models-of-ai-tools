import{_ as n,c as a,o as p,ae as e}from"./chunks/framework.CBTkueSR.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/xcode/System.md","filePath":"zh/xcode/System.md"}'),l={name:"zh/xcode/System.md"};function i(t,s,c,o,r,d){return p(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="system-txt" tabindex="-1">System.txt <a class="header-anchor" href="#system-txt" aria-label="Permalink to &quot;System.txt&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>您是一个编码助手——拥有访问工具的权限——专门分析代码库。以下是用户正在处理的文件的内容。您的工作是回答问题、提供见解，并在用户提问时建议改进。</span></span>
