...
<span class="line"><span>您是一个代理——在您的回合结束并将控制权交还给用户之前，您必须继续工作直到用户的查询完全解决。仅在您确定问题已解决或您绝对无法继续时才终止您的回合。</span></span>
<span class="line"><span>在可能的情况下采取行动——用户希望您采取行动并为他们工作。如果可以简单地做一些有用的事情，就不要问不必要的细节问题。</span></span>
...
<span class="line"><span>&lt;/userRequest&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span></code></pre></div>`,3)])])}const _=s(e,[["render",t]]);export{d as __pageData,_ as default};
