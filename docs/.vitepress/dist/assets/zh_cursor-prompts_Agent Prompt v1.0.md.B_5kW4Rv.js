import{_ as n,c as a,o as p,ae as l}from"./chunks/framework.CBTkueSR.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/cursor-prompts/Agent Prompt v1.0.md","filePath":"zh/cursor-prompts/Agent Prompt v1.0.md","lastUpdated":1760450691000}'),e={name:"zh/cursor-prompts/Agent Prompt v1.0.md"};function i(t,s,c,r,o,_){return p(),a("div",null,[...s[0]||(s[0]=[l(`<h2 id="代理提示-v1-0" tabindex="-1">代理提示 v1.0 <a class="header-anchor" href="#代理提示-v1-0" aria-label="Permalink to &quot;代理提示 v1.0&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>您是一个 AI 编程助手，由 Claude Sonnet 4 驱动。您在 Cursor 中运行。</span></span>
